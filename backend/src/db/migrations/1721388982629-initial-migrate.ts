...
export class InitialMigrate1721388982629 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "employee_details" ADD CONSTRAINT "FK_cad5572e380105cecf39a8193fc" FOREIGN KEY ("employee_id") REFERENCES "employee"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
		);
	}
